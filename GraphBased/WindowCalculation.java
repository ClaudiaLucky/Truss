...
public class WindowCalculation {
    ...
    public Rectangle getOverlapArea(Rectangle r1, Rectangle r2){
        int topLeftX = Math.max(r1.topLeftX, r2.topLeftX);
        int bottomRightX = Math.min(r1.bottomRightX, r2.bottomRightX);

        int topLeftY = Math.max(r1.topLeftY, r2.topLeftY);
        int bottomRightY = Math.min(r1.bottomRightY, r2.bottomRightY);
    ...
    // if rectangle; for a hidden window, this is basically empty.
